...
long __syscall_getpriority(long,long);
long __syscall_getresgid(long,long,long);
long __syscall_getresuid(long,long,long);
...
long __syscall_setpriority(long,long,long);
...
static __attribute__((always_inline)) long __syscall_dispatch(long n, long a, long b, long c, long d, long e, long f)
{
    ...
    case __NR_getpriority: return __syscall_getpriority(a, b);
	case __NR_getresgid: return __syscall_getresgid(a, b, c);
	case __NR_getresuid: return __syscall_getresuid(a, b, c);
    ...
    case __NR_setpriority: return __syscall_setpriority(a, b, c);
	...
	default: return __unsupported_syscall(n, a, b, c, d, e, f);
	};
}
